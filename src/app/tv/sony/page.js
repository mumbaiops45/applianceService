...
export const metadata = {
  ...
  description: 'Expert Sony TV repair for display, audio, and smart TV issues.',
};
...
export default function Page() {
  ...
  return (
    <>
      <ServiceHero title={content.title} description={content.description} brand="Sony" brandSlug="sony" category="TV" categorySlug="tv" badge={content.badge} stats={content.stats} heroImage={content.heroImage} />
      <BrandInfo title="Sony TV" description={content.introText} highlights={content.highlights} />
