...
import {
  ...
  BadgeCheck, PackageCheck, Receipt, MapPin, Users, ThumbsUp, HelpCircle,
  ChevronDown, Zap, Gauge, Droplets, Volume2, Tv, Wind, RotateCw, MonitorCheck,
  PhoneCall, CalendarCheck, Truck, MessageCircle, ClipboardCheck, Headphones,
} from 'lucide-react';
...
const warrantyPoints = [
  ...
  { icon: Headphones, label: 'Service support after repair' },
...
const testingChecks = [
  ...
  { icon: Volume2, label: 'Noise or Vibration' },
...
const whyChoose = [
  { icon: ShieldCheck, title: 'Reliable Support', desc: 'ApplianceCare focuses on providing dependable repair assistance for everyday household appliances.' },
  { icon: PackageCheck, title: 'Quality Parts', desc: 'We prioritize genuine or suitable quality replacement components based on the repair requirement.' },
  { icon: Wrench, title: 'Experienced Technicians', desc: 'Our technicians use practical knowledge and appropriate tools to inspect and repair supported appliances.' },
  { icon: Receipt, title: 'Transparent Service', desc: 'We explain the problem and recommended repair before approved work begins.' },
  { icon: CalendarCheck, title: 'Customer Convenience', desc: 'Our service is designed around convenient booking, doorstep assistance, same-day support when available, and after-service guidance.' },
];
    ...
    <div className="min-h-screen bg-[linear-gradient(135deg,_#fdf2f4_0%,_#ffffff_50%,_#eef4ff_100%)]">
      ...
      <section className="px-4 pb-18 pt-28 sm:px-6 lg:px-8">
        <div className="container mx-auto max-w-7xl rounded-[36px] border border-slate-200/80 bg-white/80 p-8 shadow-2xl shadow-slate-200/70 backdrop-blur md:p-12 lg:p-16">
          <div className="grid items-center gap-10 lg:grid-cols-[1fr]">
            <div>
              <h1 className="text-4xl font-black leading-tight text-[#0B1A2E] sm:text-5xl">
                Appliance Repair Service Features –{' '}
                <span className="text-[#E0293D]">Reliable, Transparent &amp; Customer-Focused</span>
              </h1>

              <h2 className="mt-6 inline-flex items-center gap-2 rounded-full border border-[#E0293D]/20 bg-[#FFF5F6] px-4 py-2 text-sm font-semibold text-[#B81F30]">
                <Sparkles size={16} /> Premium Features
              </h2>

              <h3 className="mt-6 text-2xl font-bold text-[#0B1A2E] sm:text-3xl">
                Everything You Want in a Professional Repair Experience
              </h3>

              <p className="mt-5 text-lg leading-8 text-slate-600 text-justify">
                At ApplianceCare, our Appliance Repair Service Features are designed to make appliance repair simple, convenient, and reassuring. We combine experienced technicians, quality parts, transparent communication, and dependable customer support.
              </p>

              <p className="mt-4 text-lg leading-8 text-slate-600 text-justify">
                From booking your service to final testing, every step is focused on providing a smooth customer experience.
              </p>
      ...
      <section className="py-20 md:py-24">
        <div className="container mx-auto max-w-7xl px-4">
          <div className="grid items-center gap-14 lg:grid-cols-2">
            <div>
              <h2 className="text-4xl font-bold text-[#0B1A2E] md:text-5xl">
                Warranty-Backed <span className="text-[#E0293D]">Repairs</span>
              </h2>

              <h3 className="mt-5 text-2xl font-bold text-[#0B1A2E]">
                Reliable Repairs with Service Support
              </h3>
      ...
      <section className="bg-slate-50 py-20 md:py-24">
        <div className="container mx-auto max-w-7xl px-4">
          <div className="mx-auto max-w-3xl text-center">
            <h2 className="text-4xl font-bold text-[#0B1A2E] md:text-5xl">
              Customer-First <span className="text-[#E0293D]">Support</span>
            </h2>
            ...
            <p className="mt-5 text-lg leading-8 text-slate-600">
              We believe good service goes beyond fixing an appliance. Our team keeps customers informed throughout the repair process.
            </p>

            <p className="mt-4 text-lg leading-8 text-slate-600">
              Our Appliance Repair Service Features include helpful booking assistance, clear communication, technician coordination, and after-service support.
            </p>
          </div>
          ...
          <div className="mt-16 grid gap-8 md:grid-cols-2">
            ...
            <div className="rounded-[28px] border border-slate-200 bg-white p-8 shadow-sm">
              ...
              <p className="mt-4 leading-7 text-slate-600">
                Our technicians explain the identified issue and recommended repair before proceeding with approved work.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto max-w-7xl px-4">
          <div className="grid items-center gap-14 lg:grid-cols-2">
            <div className="order-2 lg:order-1">
              <p className="text-base font-semibold text-[#0B1A2E]">Same-day support may depend on:</p>
            ...
            <div className="order-1 lg:order-2">
              ...
              <h2 className="mt-5 text-4xl font-bold text-[#0B1A2E] md:text-5xl">
                Same-Day <span className="text-[#E0293D]">Support</span>
              </h2>

              <h3 className="mt-5 text-2xl font-bold text-[#0B1A2E]">
                Faster Assistance for Common Appliance Issues
              </h3>

              <p className="mt-5 text-lg leading-8 text-slate-600 text-justify">
                A faulty appliance can disrupt your daily routine. Our{' '}
                Appliance Repair Service Features include same-day support
        ...
        <div className="container mx-auto max-w-7xl px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <h2 className="mt-6 text-4xl font-bold text-[#0B1A2E] md:text-5xl">
              Genuine Replacement <span className="text-[#E0293D]">Parts</span>
            </h2>
          </div>
          ...
          <div className="mt-16 grid gap-8 lg:grid-cols-2">
            <div className="rounded-[28px] border border-slate-200 bg-white p-8 shadow-lg">
              ...
              <p className="mt-4 leading-7 text-slate-600">
                ...
                performance. We prioritize Genuine Spare Parts or suitable
                quality components based on the appliance brand, model, and repair requirement.
              </p>

              <p className="mt-4 leading-7 text-slate-600">
                Our Appliance Repair Service Features are designed
        ...
        <div className="container mx-auto max-w-7xl px-4">
          <div className="grid items-center gap-14 lg:grid-cols-2">
            ...
            <div>
              ...
              <p className="mt-4 text-lg leading-8 text-slate-600 text-justify">
                Our Appliance Repair Service Features support transparent communication so customers can make informed decisions.
              </p>
            </div>
      ...
      <section className="py-20 md:py-24">
        <div className="container mx-auto max-w-6xl px-4">
          <div className="mx-auto max-w-3xl text-center">
            <span className="inline-flex items-center gap-2 rounded-full bg-[#E0293D]/10 px-5 py-2 text-sm font-semibold text-[#E0293D]">
              <Truck size={16} /> DOORSTEP SERVICE
            </span>
            <h2 className="mt-6 text-4xl font-bold text-[#0B1A2E] md:text-5xl">
              Same-Day Doorstep <span className="text-[#E0293D]">Convenience</span>
            </h2>
          </div>
      ...
      <section className="bg-slate-50 py-20 md:py-24">
        <div className="container mx-auto max-w-7xl px-4">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-4 text-base font-semibold text-[#0B1A2E]">
              The appliance may be tested for:
            </p>
          </div>
          ...
          <p className="mx-auto mt-8 max-w-3xl text-center text-lg leading-8 text-slate-600">
            These Appliance Repair Service Features help ensure the
          ...
          <div className="mt-16 grid gap-6 sm:grid-cols-2 lg:grid-cols-5">
            {whyChoose.map((item, index) => {
              ...
              return (
                <div
                  key={index}
                  className="flex flex-col items-center rounded-3xl border border-slate-200 bg-white p-6 text-center shadow-sm transition hover:-translate-y-2 hover:shadow-xl"
                >
          ...
          <div className="mt-14 space-y-4">
            {faqs.map((item, idx) => (
              ...
              >
                ...
                <p className="mt-4 pl-14 text-[16px] leading-8 text-slate-600">{item.a}</p>
              </details>
            ))}
          </div>
        </div>
      ...
      {/* ============================================ */}
      {/* BUILT AROUND BETTER SERVICE + FINAL CTA */}
      {/* ============================================ */}
          ...
          <div className="rounded-[36px] border border-[#E0293D]/15 bg-linear-to-br from-[#FFF5F6] via-white to-[#eef4ff] p-10 shadow-xl md:p-14">
            ...
            <div>
              <h2 className="text-3xl font-bold text-[#0B1A2E] md:text-4xl">
                ApplianceCare –{' '}
                <span className="text-[#E0293D]">Built Around Better Service</span>
              </h2>
            ...
            <div className="mt-10">
              ...
              <div className="mt-6 flex flex-wrap gap-3">
                {serviceBenefits.map((benefit) => (
                  ...
                  >
                    <CheckCircle2 size={16} className="text-[#E0293D]" />
                    {benefit}
                  </span>
                ))}
              </div>
            ...
            <div className="mt-8">
              ...
              <Link
                href="/contact"
                className="mt-6 inline-flex items-center gap-2 rounded-full bg-[#E0293D] px-7 py-3.5 font-semibold text-white transition hover:bg-[#B81F30]"
              >
