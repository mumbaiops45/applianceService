...
<div className="sticky top-24 overflow-hidden rounded-[32px] bg-linear-to-br from-red-600 via-red-500 to-red-700 p-10 text-white shadow-2xl">
    ...
    <div className="mt-10 space-y-4">
      ...
      <button className="flex w-full items-center justify-center gap-3 rounded-2xl bg-white py-4 font-semibold text-red-600 transition-all duration-300 hover:scale-105">
      ...
      <button className="flex w-full items-center justify-center gap-3 rounded-2xl border border-white/30 bg-white/10 py-4 font-semibold text-white backdrop-blur transition-all duration-300 hover:bg-white hover:text-red-600">
