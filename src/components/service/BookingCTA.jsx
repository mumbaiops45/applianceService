    ...
    <section className="bg-[linear-gradient(135deg,_#0B1A2E_0%,_#132B45_100%)] py-20 text-white">
      <div className="container mx-auto px-4 text-center">
        <div className="mx-auto max-w-3xl rounded-[32px] border border-white/10 bg-white/10 p-8 shadow-2xl backdrop-blur md:p-12">
          <h2 className="text-3xl font-black md:text-4xl">Book Your {brand} {category} Service <span className="text-[#E0293D]">Today</span></h2>
          <p className="mx-auto mt-4 max-w-2xl text-lg text-slate-300">Get a free estimate, schedule a visit, and speak with a specialist about the fastest fix for your appliance.</p>
